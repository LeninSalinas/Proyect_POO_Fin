...
public class Factura {
    ...
    private double numeroRepuestos;   
...
//    private ;
    ...
    public Factura(Persona Nombre, Cliente Rtn, Cliente Telefono, Carros Placa, String Respuesto, int precioRepuesto, double numeroRepuestos, double subtotal, double ISV, double Descuento, double totalPagar) {
        this.Nombre = Nombre;
        this.Rtn = Rtn;
    ...
    public double getNumeroRepuestos() {
        return numeroRepuestos;
    }

    public void setNumeroRepuestos(double numeroRepuestos) {
        this.numeroRepuestos = numeroRepuestos;
    }
    ...
    public double calcularCant(){
        if (precioRepuesto==0) {            
            totalPagar=precioRepuesto*2;
        }
        return totalPagar;
    }
}
